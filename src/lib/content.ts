...
export const crDiagnosticoContent: DiagnosticoDigitalContent = {
  ...
  painPoints: {
    sectionLabel: '¿Tu clínica enfrenta estos desafíos?',
    title: 'Problemas que frenan el crecimiento de tu consulta',
    description: 'Si alguna de estas situaciones te resulta familiar, no estás solo. Son los retos más comunes que vemos en clínicas privadas de Costa Rica.',
    points: [
      {
        icon: 'AlertTriangle',
        title: 'Citas perdidas y espacios vacíos',
        description: 'Pacientes que no se presentan, cancelaciones de última hora, y huecos en la agenda que reducen tus ingresos.',
        impact: 'Cada espacio vacío es dinero que se pierde.',
      },
      {
        icon: 'Smartphone',
        title: 'Agenda desordenada',
        description: 'Llamadas constantes para agendar, confirmar o reprogramar citas. Si no contestás, el paciente busca otra clínica.',
        impact: 'Tu consulta depende de que estés disponible siempre.',
      },
      {
        icon: 'Clock',
        title: 'Demasiado tiempo en papeleo',
        description: 'Horas dedicadas a gestión administrativa que podrías usar atendiendo pacientes o con tu familia.',
        impact: 'El papeleo reduce tus ingresos silenciosamente.',
      },
      {
        icon: 'UserX',
        title: 'Pacientes que no regresan',
        description: 'Seguimientos que se olvidan, recordatorios que no se envían, pacientes que necesitan atención pero no vuelven.',
        impact: 'La falta de seguimiento te cuesta pacientes fieles.',
      },
      {
        icon: 'Image',
        title: 'Presencia digital que no refleja tu experiencia',
        description: 'Tu página web está desactualizada — o no tenés una. Pacientes te buscan en internet y encuentran a tu competencia.',
        impact: 'Tu reputación médica debería brillar también online.',
      },
      {
        icon: 'EyeOff',
        title: 'Sin control de dónde vienen los pacientes',
        description: 'No sabés qué canal te trae más citas. No sabés qué funciona. Tomás decisiones sin datos.',
        impact: 'Sin visibilidad, no podés crecer con estrategia.',
      },
    ],
    emotionalClose: 'Estos problemas no son tu culpa. Simplemente no tenés las herramientas correctas. Pero seguir así puede costarte más pacientes — y más ingresos — de lo que imaginás.',
  },
  reframe: {
