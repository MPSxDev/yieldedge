        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-gray-900 font-semibold">sitios web modernos</span>,{' '}
              <span className="text-gray-900 font-semibold">automatización IA</span> y{' '}
              <span className="text-gray-900 font-semibold">sistemas escalables</span> que generan resultados medibles.
            </motion.p>
